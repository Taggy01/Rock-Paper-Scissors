...
if(compData === vall){
    console.log('Tie.');
    // alert(`You Choose ${vall} and Computer Choose ${compData}, Tie.`);
    ...
    // alert(`You Choose ${vall} and Computer Choose ${compData}, You Lose.`);
    ...
    console.log('You Win.');
    // alert(`You Choose ${vall} and Computer Choose ${compData}, You Win.`);
...
function count(){
    document.querySelector('.count').innerHTML = `Win : ${winCount} , Lose = ${loseCount} , Tie = ${tieCount}.`;
}